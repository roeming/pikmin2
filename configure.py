...
LIBS = [
    ...
    },
    {
        ...
        "objects": [
            ...
            "JSystem/JParticle/JPAExTexShape",
            "JSystem/JParticle/JPAExtraShape",
            ...
            "JSystem/JParticle/JPAResourceManager",
    ...
    },
    {
        ...
        "objects": [
            ...
            "JSystem/JAudio/JAS/JASTrackInterrupt",
    ...
    },
    {
        ...
        "host": True,
        "objects": [
            "JSystem/JAudio/dsp/dspproc",
            "JSystem/JAudio/dsp/dsptask",
            ["JSystem/JAudio/dsp/osdsp", True],
            "JSystem/JAudio/dsp/osdsp_task",
        ],
    },
    {
        "lib": "JAudio_JAI",
    ...
    },
    {
        ...
        "objects": [
            ...
            "Dolphin/TRK_MINNOW_DOLPHIN/CircleBuffer",
            ["Dolphin/TRK_MINNOW_DOLPHIN/gdev/main", True],
    ...
    },
    {
        ...
        "objects": [
            ...
            "Dolphin/MSL_C/alloc",
            ["Dolphin/MSL_C/ansi_files", True],
            "Dolphin/MSL_C/ansi_fp",
            ["Dolphin/MSL_C/arith", True],
            ["Dolphin/MSL_C/buffer_io", True],
            ["Dolphin/MSL_C/critical_regions.gamecube", True],
            ["Dolphin/MSL_C/ctype", True],
            "Dolphin/MSL_C/direct_io",
            ...
            "Dolphin/MSL_C/printf",
            ["Dolphin/MSL_C/rand", True],
            ["Dolphin/MSL_C/float", True],
            "Dolphin/MSL_C/scanf",
            ["Dolphin/MSL_C/string", True],
            "Dolphin/MSL_C/strtold",
            "Dolphin/MSL_C/strtoul",
            ["Dolphin/MSL_C/wchar_io", True],
            ["Dolphin/MSL_C/uart_console_io_gcn", True],
            ["Dolphin/MSL_C/e_asin", True],
            ["Dolphin/MSL_C/e_atan2", True],
            ["Dolphin/MSL_C/e_exp", True],
            ["Dolphin/MSL_C/e_fmod", True],
            ["Dolphin/MSL_C/e_log", True],
            ["Dolphin/MSL_C/e_log10", True],
            ["Dolphin/MSL_C/e_pow", True],
            ["Dolphin/MSL_C/e_rem_pio2", True],
            ["Dolphin/MSL_C/k_cos", True],
            ["Dolphin/MSL_C/k_rem_pio2", True],
            ["Dolphin/MSL_C/k_sin", True],
            ["Dolphin/MSL_C/k_tan", True],
            ["Dolphin/MSL_C/s_atan", True],
            ["Dolphin/MSL_C/s_ceil", True],
            ["Dolphin/MSL_C/s_copysign", True],
            ["Dolphin/MSL_C/s_cos", True],
            ["Dolphin/MSL_C/s_floor", True],
            ["Dolphin/MSL_C/s_frexp", True],
            ["Dolphin/MSL_C/s_ldexp", True],
            ["Dolphin/MSL_C/s_modf", True],
            ["Dolphin/MSL_C/s_sin", True],
            ["Dolphin/MSL_C/s_tan", True],
            ["Dolphin/MSL_C/w_asin", True],
            ["Dolphin/MSL_C/w_atan2", True],
            ["Dolphin/MSL_C/w_exp", True],
            ["Dolphin/MSL_C/w_fmod", True],
            ["Dolphin/MSL_C/w_log10", True],
            ["Dolphin/MSL_C/w_pow", True],
            ["Dolphin/MSL_C/e_sqrt", True],
            ["Dolphin/MSL_C/math_ppc", True],
            ["Dolphin/MSL_C/w_sqrt", True],
            ["Dolphin/MSL_C/extras", True],
        ],
    },
    {
        "lib": "OdemuExi2",
